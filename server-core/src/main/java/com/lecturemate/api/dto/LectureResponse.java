...
public record LectureResponse(Long lectureId, String title, LectureStatus status, String pdfUrl) {

  public static LectureResponse from(Lecture lecture) {
    return new LectureResponse(
        lecture.getId(), lecture.getTitle(), lecture.getStatus(), lecture.getPdfUrl());
  }
}
